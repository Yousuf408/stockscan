# ═══════════════════════════════════════════════════════════════════════════════
# BACKEND / observation_backend.py – All logic, data fetching, calculations
# ═══════════════════════════════════════════════════════════════════════════════
...
def check_candle_conditions(df, tickers_list):
    """Check candle conditions for all symbols"""
...
def get_filtered_data(df, show_inside_only, show_breakout_only):
    """Apply Stage 2 filters to dataframe"""
    display_df = df.copy()
...
def prepare_display_dataframe(display_df, user_capital):
